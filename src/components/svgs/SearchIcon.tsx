    ...
    return (
        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#9B9B9B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M26.3334 25.6667L24 23.3333" stroke="#9B9B9B" strokeWidth="1.5" strokeLinecap="round"
